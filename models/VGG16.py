...
class VGG(nn.Module):
    def __init__(self, sparsity, cfg=None, num_classes=2):
...
def vgg_16_bn(sparsity=None,sparsity_channels=None,num_classes=10, original=False):
    if original:
        return VGG(sparsity=[0.] * 100,num_classes=num_classes)

    else:
        return VGG_SC(sparsity=[0.] * 100, cfg=sparsity_channels, num_classes=num_classes)
