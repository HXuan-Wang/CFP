...
parser.add_argument('-a', '--arch', metavar='ARCH', default='DDDN')

parser.add_argument(
    '--job_dir',
    type=str,
    default='./original_DDDN_5',
...
def main():
    ...
    model = DDDN(num_classes=num_classes,sparsity=[0.]*100,original=True)
    model = model.cuda()
    ...
    train_loader = DataLoader(dataset=train_data, batch_size=args.batch_size, shuffle=True, sampler=None,
                              num_workers=4)
